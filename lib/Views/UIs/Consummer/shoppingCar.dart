                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: <Widget>[
                          Image(
                            image:
                                AssetImage('assets/merkarapid-oficial-w.png'),
                            width: 200.0,
                            height: 200.0,
                            fit: BoxFit.contain,
                          ),
                ...
                return Padding(
                  ...
                  child: Ink(
                    ...
                    child: ListTile(
                      ...
                      title: Text(el.elementAt(0),
                          style: TextStyle(color: Colors.white)),
                      subtitle: Text('1 ' + el.elementAt(3),
                          style: TextStyle(color: Colors.white)),
                      trailing: Text('\$' + el.elementAt(1),
                          style: TextStyle(color: Colors.white)),
                      onTap: () {},
                    ),
                  ),
              ...
              child: Padding(
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    ...
                    bool confirm = await ShowOptions.showConfirm(
                        context,
                        'Ordenar Pedido',
                        'Desea realizar la compra por \$999.999',
                        Color.fromRGBO(244, 111, 51, 1));
                    if (confirm) {
                      ShowOptions.showAlert(
                          context,
                          'Pedido Realizado con exito',
                          'En momentos estara recibiendo los pedidos en la puerta de su hogar',
                          Color.fromRGBO(244, 111, 51, 1));
                    }
                  },
